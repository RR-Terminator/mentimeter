...
io.on("connection", (socket) => {
    ...
    // Deleting the Question By The Admin
    ...
    socket.on("deleteQuestion", async ({ index }) => {
        ...
        try {
            ...
            if (index >= 0 && index < admin.questions.length) {
                // Remove the question at the specified index
                const deletedQuestion = admin.questions.splice(index, 1);
